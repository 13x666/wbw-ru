...
// @include /^http://notabenoid\.org/book/(71715|41531|45955)/.+/
// ==/UserScript==
...
(function(window, undefined) {
    ...
    function main() {
        ...
        var book =
            (loc.indexOf('/book/41531/') == 0 || loc.indexOf('/book/71715/') == 0) ? BookType.WHAT_IF :
    ...
    if (loc.indexOf('http://notabenoid.com') == 0) {
        ...
        if (loc.indexOf('/book/71715/') != 0 && loc.indexOf('/book/41531/') != 0 && loc.indexOf('/book/45955/') != 0)
            return;
